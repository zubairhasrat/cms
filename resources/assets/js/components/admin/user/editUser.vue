      ...
      <div class="row">
          ...
          <div class="col-sm-10">
              <div class='col-lg-4 col-lg-offset-4'>
                ...
                <p class="alert alert-danger" v-if="errors.has('email')">{{ errors.first('email')}}</p>
                ...
                <div class="form-group">
                    <input type="button"  class="btn btn-primary" name="add_user" value="Update" @click="editUser" />
                </div>
            </div>
          </div>
      </div>
       ...
       editUser(){
            this.$validator.validateAll().then(res => {
                ...
                let reqObj = {
                    ...
                    this.$store.dispatch('editUser',reqObj)
